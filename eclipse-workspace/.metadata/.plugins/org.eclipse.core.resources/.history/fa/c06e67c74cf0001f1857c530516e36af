...
public class Ficheros {
    ...
    public void escribirFicheroTexto(ArrayList<Mascotas> arrLMascot) {
        ...
        try {
            //Añadimos filewriter para poder añadir información a los ficheros y no sobreescribirlos
    ...
    public void escribirEnWord(ArrayList<Mascotas> arrLMascotas) {
        ...
        for (Mascotas mascota : arrLMascotas) {
            ...
            ejecutador.addBreak();
            ejecutador.setText("Los síntomas de la mascota: " + mascota.getDescripcionSintomas());
            ejecutador.addBreak();
    ...
    public void escribirEnExcel(ArrayList<Mascotas> arrLMascotas) {
        ...
        segundaFila.createCell(4).setCellValue("Descripcion de síntomas");
